...
@Service
public class BuscarEstoquesQuantidadeBaixa {

    @Autowired
    private EstoqueRepository estoqueRepository;

    public List<Map<String, Object>> getFornecedoresComEstoqueBaixo() {
        var result = estoqueRepository.findFornecedoresComEstoqueBaixo();
